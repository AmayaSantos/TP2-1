...
public class PreguntaChoiceClasicoTest {
    ...
    @Test
    public void test01preguntaChoiceClasicoSeCreaConSuCalificador(){
    ...
    @Test
    public void test02preguntaChoiceClasicoReciberespuestasDeJugadoresEIncrementaAlQueRespondioCorrectamente(){
    ...
    @Test
    public void test03preguntaChioceClasicoReciberespuestasDeJugadoresEIncrementaEnUnoAlQueRespondioCorrectamente(){
    ...
    @Test
    public void test04preguntaChioceClasicoReciberespuestasDeJugadoresEIncrementaEnUnoAlQueRespondioCorrectamente(){
    ...
    @Test
    public void test05preguntaChioceClasicoReciberespuestasDeJugadoresEIncrementaEnUnoAlQueRespondioCorrectamente(){
