...
public class PreguntaChoiceParcialTest {
    ...
    Calificador tipoClasico=new CalificadorParcial();
    @Test
    public void test01preguntaChoiceParcialSeCreaConSuCalificador(){
    ...
    @Test
    public void test02preguntaChoiceParcialReciberespuestasDeJugadoresEIncrementaAlQueRespondioCorrectamente(){
    ...
    @Test
    public void test03preguntaChioceParcialReciberespuestasDeJugadoresEIncrementaEnUnoAlQueRespondioCorrectamente(){
    ...
    @Test
    public void test04preguntaChioceParcialReciberespuestasDeJugadoresEIncrementaEnUnoAlQueRespondioCorrectamente(){
    ...
    @Test
    public void test05preguntaChioceParcialReciberespuestasDeJugadoresEIncrementaEnUnoAlQueRespondioCorrectamente(){
